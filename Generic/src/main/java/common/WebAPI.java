...
public class WebAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("windows") String os, @Optional("10") String os_version, @Optional("chrome-options") String browserName, @Optional("34")
                              String browserVersion, @Optional("https://www.jqueryui.com") String url) throws IOException {
    ...
    //WebElement resizeElement = driver.findElement(By.xpath(Snippet));
    //resize(resizeElement,)
    //}

    public void radioButton(String radioButton1) {
        WebElement radio = driver.findElement(By.xpath(radioButton1));
